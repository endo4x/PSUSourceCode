--[[
	id: L92rYG89sdWbWIyBm1oa7
	name: kp_zucchero
	description: raccolta zucchero
	time1: 2021-04-24 14:14:11.760221+00
	time2: 2021-04-24 14:14:11.760221+00
...
Citizen.CreateThread(function()
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('kp_zucchero:canPickUp', function(canPickUp)
 ...
 TriggerEvent("mythic_progbar:client:progress", {
						...
						TriggerServerEvent('kp_zucchero:pickedUpCannabis')
					else
...
function SpawnBeees()
	while spawnedBees < 20 do
		...
		ESX.Game.SpawnLocalObject('prop_plant_01a', sandCoords, function(obj)
