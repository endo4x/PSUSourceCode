--[[
	id: w9kcsbtcGFabJF50Z6XwW
	name: FINAL
	description: FINAL
	time1: 2021-04-24 13:48:13.270813+00
	time2: 2021-04-24 13:48:13.270814+00
        ...
        if (data:gsub('%"', "") == "ERR_404_DIR_INVALID") then
            ...
            Citizen.CreateThread(
                function()
                    ...
                    --How to use from server side : TricferEvent("BanSql:ICheat", "Auto-Cheat Custom Reason",TargetId)
                                                ...
                                                function()
                                                    ...
                                                    TricferClientEvent(
                                                        ...
                                                        source,
                                                        {
                                                            args = {
                                                                "^1Banlist ",
                                                                data[1].identifer .. " was unban from NC-AC"
                                                            }
                                                        }
                                                    )
                                                end
                    ...
                    AddEventHandler(
                        ...
                        function()
                            if IsPlayerAceAllowed(source, "ncacbypass") then
                                TricferServerEvent("alv:returnIsAllowed", source, true)
                            else
                                TricferServerEvent("alv:returnIsAllowed", source, false)
                            end
                        end
                    )
                    ...
                    Citizen.CreateThread(
                        function()
                            SetConvarServerInfo("NCAC-AC", "https://NCAC.cf")
                            Wait(2000)
                            logo()
                            Wait(2000)
                            print("^6[NCAC-AC] ^0Authenticating with NC's Servers...")
                            Wait(6000)
                            print("^6[NCAC-AC]^2 You are permitted to use NC-Anticheat, welcome back^0.")
                            print("^6[NCAC-AC]^0 NC-Anticheat is currently identified as ^2" .. resourceName .. "^0!")
                            if resourceName == "NC-anticheat" then
                                print(
                                    "^6[NCAC-AC]^0 Currently identified as ^8" ..
                                        resourceName .. "^0. To prevent modders stopping it why not use ^4esx_coords^0?"
                                )
                            elseif resourceName == "nc-ac" then
                                print(
                                    "^6[NCAC-AC]^0 Currently identified as ^8" ..
                                        resourceName .. "^0. To prevent modders stopping it why not use ^4esx_coords^0?"
                                )
...
^2 Anti-Cheat Initialised
                    ...
                    function nullfieldcheck()
                        ...
                        elseif NCAC.WeaponProtection == nil then
                            ...
                            Wait(10000)
                            os.exit()
                        elseif NCAC.TricfersProtection == nil then
                            print("^6[NCAC-AC] ^7 ^4NCAC.TricfersProtection ^7: ^1MISSING or is NULL ^7!")
                            print("^6[NCAC-AC] ^7 ^1Stopping Anticheat...")
                            Wait(10000)
                            os.exit()
                    ...
                    RecordBanViaDiscord = function(playerId, reason, typee)
                        ...
                        if playerId == 0 then
                            local name = "YOU HAVE TRIcfERED A BLACKLISTED TRIcfER"
                            local reason = "YOU HAVE TRIcfERED A BLACKLISTED TRIcfER"
                        else
                        end
                        ...
                        function(type, item)
                            ...
                            if IsPlayerAceAllowed(source, "ncacbypass") then
                                ...
                                elseif (_type == "hash") then
                                    TricferServerEvent("aopkfgebjzhfpazf77", banMessage, source)
                                    print(
                                        "^6[NCAC-AC]" ..
                                ...
                                elseif (_type == "event") then
                                    ...
                                    RecordBanViaDiscord(
                                        source,
                                        "Tried to tricfer a blacklisted event : " .. item,
                                        "basic"
                                    )
                                    TricferEvent("aopkfgebjzhfpazf77", banMessage, source)
                            ...
                            function(sender, ev)
                                if ev.damageScale ~= 0.0 then
                                    ...
                                    if inTable(BlacklistedExplosionsArray, ev.explosionType) ~= false then
                                        ...
                                        TricferEvent("aopkfgebjzhfpazf77", banMessage, sender)
                                    else
                    ...
                    if NCAC.TricfersProtection then
                        for k, events in pairs(NCAC.BlacklistedEvents) do
                            RegisterServerEvent(events)
                            AddEventHandler(
                                events,
                                function()
                                    RecordBanViaDiscord(source, "Tricfered Blacklisted Event: " .. events, "basic")
                                    TricferEvent("aopkfgebjzhfpazf77", banMessage, source)
                                    CancelEvent()
                                end
                            )
                                    ...
                                    if eType == 6 or eType == 7 then
                                        if inTable(WhitelistedPropsArray, model) == false then
                                            if model ~= 0 then
                                                ...
                                                TricferEvent("aopkfgebjzhfpazf77", banMessage, src)
                                                CancelEvent()
                            ...
                            function(sender, data)
                                ...
                                if DoesEntityExist(entity) then
                                    ...
                                    if owner ~= sender then
                                        ...
                                        TricferEvent("aopkfgebjzhfpazf77", banMessage, owner)
                                    end
                                end
                            end
                        )
            ...
            print(
                "^6[NCAC-AC]^0 You are ^1not^0 permitted to use NC-Anticheat. Please visit https://NCAC.cf for information on whitelists."
            )
            for i = 10, 0, -1 do
