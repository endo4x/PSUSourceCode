--[[
	id: a5yCLGkVxwIt7yFDEJReA
	name: vehicle
	description: vehicle
	time1: 2021-05-17 11:45:49.468587+00
	time2: 2021-05-17 11:45:49.468587+00
...
RegisterNetEvent('t11_vehicle:Spawn')
AddEventHandler('t11_vehicle:Spawn', function(vehicleModel)
    ...
    if 
        ...
        if not Delay then
            ...
            if DoesEntityExist(veh) then 
                TriggerServerEvent('t11_vehicle:removeVehicle', vehicleModel)
                TriggerEvent('t11:wait',false)
                Citizen.Wait(2500)
                DupeDelayVeh = false
                                ...
                                local veh = GetVehiclePedIsUsing(playerPed)
                                    ...
                                    if not DoesEntityExist(veh) then 
                                        if vehName == "wastlndr" then
                                            store = 'wastelander' 
                                            TriggerServerEvent('t11_vehicle:storeVehicle2', store)
                                            Delay = true
                                            Citizen.Wait(500)
                                            DupeDelayVeh = false
                                            Citizen.Wait(DelayCounter)
                                        ...
                                        elseif vehName == "trophy" then
                                            ...
                                            TriggerServerEvent('t11_vehicle:storeVehicle', vehName)
                                            Delay = true
                                            Citizen.Wait(500)
                                            DupeDelayVeh = false
                                            Citizen.Wait(DelayCounter)
