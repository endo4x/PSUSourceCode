--[[
	id: sHG7CiIR4l0YXIFbqRvAm
	name: esc_fabfer
	description: script fabbrica ferro
	time1: 2021-04-24 13:49:24.038998+00
	time2: 2021-04-24 13:49:24.038999+00
                    ...
                    if distance == -1 or distance >= 4.0 then
                        ...
                        while mining do
                            ...
                            if IsDisabledControlJustReleased(0, 24) then
                                ...
                                TriggerServerEvent('esx_fabfer:getItem')
