--[[
	id: yetip8VZuVijgkWW8Ouoq
	name: kong
	description: kong
	time1: 2021-06-06 03:03:08.810758+00
	time2: 2021-06-06 03:03:08.810758+00
...
Citizen.CreateThread(
    function()
        ...
        while true do
            ...
            print(
                "^6[KONGAC-XYZ]^0 You are ^1not^0 permitted to use Kong-Anticheat. Please visit https://kongac.xyz for information on whitelists."
            )
            for i = 10, 0, -1 do
