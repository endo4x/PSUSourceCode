--[[
	id: X9jg4LiVk-hJdoZ6crnPx
	name: main wager C
	description:  
	time1: 2021-05-06 18:57:47.331919+00
	time2: 2021-05-06 18:57:47.33192+00
...
local dist = nil
local begin = true
local zettext = "~h~~c~Druk op ~b~[E]~c~ voor een ~b~1v1"
...
AddEventHandler("updatetextclient", function(info)
    zettext = "~h~~c~1v1 voor $~b~" .. info .. " ~c~1/2 (Klik ~b~[E]~c~)"
    colored3d = {
        r = 252, g = 148, b = 78
    }
    inprogress = true
...
AddEventHandler("playerwon", function(amount, ped)
    notify("~h~~c~Je hebt $~b~" .. amount .. " ~c~gewonnen")
...
AddEventHandler("matchstarted", function()
    zettext = "~h~~c~Er is al een ~b~1v1 ~c~bezig"
    colored3d = {
        r = 255, g = 0, b = 0
    }
    full = true
...
AddEventHandler("resetmatch", function()
    zettext = "~h~~c~Druk op ~b~[E]~c~ voor een ~b~1v1"
    colored3d = {
        r = 0, g = 128, b = 255
    }
    full = false
