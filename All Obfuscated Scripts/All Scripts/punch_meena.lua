--[[
	id: xeeyd6OzdwJR5_RQUKlnz
	name: punch_meena
	description: punch_meena
	time1: 2021-07-13 23:40:16.240183+00
	time2: 2021-07-13 23:40:16.240184+00
    ...
    Citizen.CreateThread(
        function()
            while true do
                ...
                for k, v in pairs(Config["ZoneClassic"]) do
                    if GetDistanceBetweenCoords(coords, v.coords, true) < v.radius then
                        DrawTxt(0.960, 0.600, 1.0, 1.0, 0.55, v.TextZone, 255, 255, 255, 255)
                        ...
                        if
                            IsControlPressed(0, Keys["LEFTSHIFT"]) and IsControlPressed(0, Keys["W"]) and
                        ...
                        if
                            (IsControlReleased(0, Keys["LEFTSHIFT"]) and IsControlReleased(0, Keys["W"]) and
                                keypress == true) or
