--[[
	id: mcadsjV0TKeox8ftSSnlZ
	name: vsyncr
	description: vsyncr
	time1: 2021-05-21 22:25:28.525038+00
	time2: 2021-05-21 22:25:28.525039+00
...
RegisterNetEvent('vSync:updateTimeRR')
AddEventHandler('vSync:updateTimeRR', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
...
AddEventHandler('playerSpawned', function()
    TriggerServerEvent('vSync:requestSyncRR')
end)
