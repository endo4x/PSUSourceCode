--[[
	id: 2XejEJ-cWIuwSIXoFknpc
	name: kp_riso
	description: raccolta riso
	time1: 2021-04-24 14:12:31.735291+00
	time2: 2021-04-24 14:12:31.735291+00
...
Citizen.CreateThread(function()
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('kp_riso:canPickUp', function(canPickUp)
 ...
 TriggerEvent("mythic_progbar:client:progress", {
						...
						TriggerServerEvent('kp_riso:pickedUpCannabis')
					else
...
function SpawnBeees()
	while spawnedBees < 20 do
		...
		ESX.Game.SpawnLocalObject('prop_plant_fern_02b', sandCoords, function(obj)
