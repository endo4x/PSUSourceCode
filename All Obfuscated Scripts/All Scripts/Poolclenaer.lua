--[[
	id: JxGUrgVS00kYWWSNA11wK
	name: Poolclenaer
	description: Poolclenaer
	time1: 2021-04-26 13:10:16.542921+00
	time2: 2021-04-26 13:10:16.542922+00
...
function StartNPCJob()
	...
	Distance = GetGpsDistance(coords, zone.Pos)
...
function StopNPCJob(cancel)
    ...
    if cancel then
	  ESX.ShowNotification(_U('cancel_mission'))
		...
		TriggerServerEvent('esx_poolcleaner:GiveVRPItem')
		StartNPCJob()
		Done = true
	end
end
