--[[
	id: mwamr49_A7Vyc23sYqau2
	name: Hypnotic resolver
	description: Hypnotic resolver
	time1: 2021-05-18 07:46:42.119503+00
	time2: 2021-05-18 07:46:42.119504+00
	uploader: tb6EFhYH-7jyKZHLWyeR3AX5-iluMfWIGmfn88am
	uploadersession: vJqzCeOlja4optdac7GatNvD35mwDb
	flag: f
--]]

-- Resolver by ImBannedFromIDK#7049
local http = require "gamesense/http"

http.get("https://api.covid19api.com/summary", function(success, response)
  ...
  print("Welcome back to Hypnotic")
  print("Update logs on my Discord server")
  print("If you need Help dm me or create a ticket")
  print("Have a great day using Hypnotic")
end)
...
local indicatorCheckbox = ui.new_checkbox("Lua", "B", "[hypnotic] Resolver Angle Status")
ui.new_checkbox("Lua", "B", "[hypnotic] SECRET BUTTON")
...
function resolver_c:render()
    ...
    for i=1, #entities do
		...
		if indicatorEnabled then
			...
			indicator(255,255,255,255, state, '{',max_yaw,'}', '[',fix_value,']')
		end
...
local master_switch = ui.new_checkbox('Lua', 'B', '[Hypnotic] Log Aimbot Shots')
