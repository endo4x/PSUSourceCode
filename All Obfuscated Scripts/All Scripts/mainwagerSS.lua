--[[
	id: sm27grRJQytf6hlWa2b1o
	name: main wager SS
	description:  
	time1: 2021-05-06 18:58:52.183546+00
	time2: 2021-05-06 18:58:52.183547+00
...
AddEventHandler("getsecondplayer", function(data)
    ...
    if firstplayer == data then
        TriggerClientEvent('chat:addMessage', src, {args = {"^1v1", "Je zit al in een ^4Wachtrij"}})
    else
