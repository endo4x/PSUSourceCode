--[[
	id: AqiXeyAcIrjTiCn8ynhhB
	name: esx_muccajob
	description: lavoro macello mucca
	time1: 2021-04-24 16:34:14.025456+00
	time2: 2021-04-24 16:34:14.025457+00
...
local AnimalPositions = {
	{ x = 2131.88, y = 5010.36, z = 41.27 }, 
	{ x = 2123.37, y = 5002.04, z = 41.12 }, 
	{ x = 2115.05, y = 5006.45, z = 41.31 }, 
	{ x = 2120.39, y = 5013.37, z = 41.42 },
	{ x = 2123.85, y = 5010.41, z = 41.29 } 
...
local Positions = {
	['StartHunting'] = { ['hint'] = '[E] Start working', ['x'] = 2141.30, ['y'] = 5025.46, ['z'] = 41.76 },
	['Sell'] = { ['hint'] = '[E] Sell', ['x'] = 964.30438232422, ['y'] = -2105.92578125, ['z'] = -311.463960647583 },
    ['Porkpack'] = { ['hint'] = '[E] Impacchetta manzo', ['x'] = 985.17, ['y'] = -2121.66, ['z'] = 30.47 }
				...
				for index, value in ipairs(AnimalsInSession) do
					if DoesEntityExist(value.id) then
						...
						if PlyToAnimal < 2.0 then
							...
							ESX.Game.Utils.DrawText3D({x = AnimalCoords.x, y = AnimalCoords.y, z = AnimalCoords.z + 1}, '[E] Prendi Mucca', 0.4)
...
function SlaughterAnimal(AnimalId)
	...
	TriggerServerEvent('esx_muccajob:reward', AnimalWeight)
...
function SellItems()
    TriggerServerEvent('esx_muccajob:sell')
end
...
function Porkpack()
	...
	TriggerServerEvent('esx_muccajob:porkpack')
end
