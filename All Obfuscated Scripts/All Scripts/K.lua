--[[
	id: CHau-wRKJzcHeqmdRiKf0
	name: K9
	description: script cani polizia
	time1: 2021-04-24 18:49:51.681751+00
	time2: 2021-04-24 18:49:51.681751+00
...
Citizen.CreateThread(function()
	while true do
		...
		-- Toggle Menu
		if IsControlPressed(1, 314) and IsControlJustPressed(1,314) then -- LEFTALT + Z
		...
		-- Attacking Key --
		if IsPlayerFreeAiming(PlayerId()) and IsControlJustPressed(1, 44) and current_dog ~= nil then
