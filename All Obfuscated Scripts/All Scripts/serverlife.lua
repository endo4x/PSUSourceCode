--[[
	id: DhmpmhJJMhGHT8HTV5qUQ
	name: server life
	description:  
	time1: 2021-05-04 18:27:52.967609+00
	time2: 2021-05-04 18:27:52.967609+00
...
AddEventHandler("getsecondplayer", function(data)
    ...
    if firstplayer == data then
        TriggerClientEvent("chat:addMessage", src, {args = {"^LifelessRP Wager", "Je zit al in een ^4Wachtrij"}})
    else
...
AddEventHandler("esx:onPlayerDeath", function(data)
    ...
    if startedit then
        if data.victim == source2 then
            ...
            TriggerClientEvent("kr:heal", source1)
            Citizen.Wait(500)   
            TriggerClientEvent("kr:revive", source2)
        ...
        elseif data.victim == source1 then
            ...
            TriggerClientEvent("kr:heal", source2)
            Citizen.Wait(500)
            TriggerClientEvent("kr:revive", source1)
