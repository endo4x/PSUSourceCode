--[[
	id: qOQhWLZ5pDREsJY-NW46R
	name: exmain
	description: exmain
	time1: 2021-05-17 11:55:08.874086+00
	time2: 2021-05-17 11:55:08.874086+00
...
AddEventHandler('esx:addInventoryItemxx', function(item, count, showNotification, newItem)
	local found = false

	for k,v in ipairs(ESX.PlayerData.inventory) do
		if v.name == item then
			TriggerEvent('conde-inventoryhud:notification', v.name,"GOT AN ITEM", count - v.count, false)
	...
	if(found == false and newItem --[[Just a check if there is a newItem]])then
		...
		--TriggerEvent('conde-inventoryhud:notification', newItem.label,"GOT AN ITEM", count, false)
	else
	...
	if showNotification then
		...
		--TriggerEvent('conde-inventoryhud:notification', item,"GOT AN ITEM", count, false)
	end
...
AddEventHandler('esx:removeInventoryItem', function(item, count, showNotification)
	...
	if showNotification then
		...
		--TriggerEvent('conde-inventoryhud:notification', item,"Eşya Silindi", count, false)
	end
