--[[
	id: GuN0pfCsIEv4gqCC7G-hy
	name: esx_pigjob
	description: macello maiali
	time1: 2021-04-24 16:36:02.123034+00
	time2: 2021-04-24 16:36:02.123035+00
...
local AnimalPositions = {
	{ x = 2182.31, y = 4968.33, z = 41.32 }, 
	{ x = 2172.51, y = 4963.99, z = 41.36 }, 
	{ x = 2169.87, y = 4969.22, z = 41.36 }, 
	{ x = 2174.43, y = 4974.16, z = 41.41 }, 
	{ x = 2182.84, y = 4967.25, z = 41.25 }, 
	{ x = 2174.06, y = 4955.28, z = 41.34 }
...
local Positions = {
	['StartHunting'] = { ['hint'] = '[E] Start working', ['x'] = 2196.49, ['y'] = 4978.15, ['z'] = 41.59 },
	['Sell'] = { ['hint'] = '[E] Sell', ['x'] = 964.30438232422, ['y'] = -2105.92578125, ['z'] = -311.463960647583 },
    ['Porkpack'] = { ['hint'] = '[E] Pork pack', ['x'] = 949.0, ['y'] = -2123.7908105469, ['z'] = 31.43868270874 }
...
function Spawnpig()
	Citizen.CreateThread(function()
		...
		for index, value in pairs(AnimalPositionstwo) do
			...
			Citizen.Wait(5000)
			local Animal = CreatePed(5, GetHashKey('a_c_pig'), value.x, value.y, value.z, 0.0, true, false)
			...
			BeginTextCommandSetBlipName("STRING")
			AddTextComponentString('Pig - Animal')
				...
				for index, value in ipairs(AnimalsInSession) do
					if DoesEntityExist(value.id) then
						...
						if PlyToAnimal < 2.0 then
							...
							ESX.Game.Utils.DrawText3D({x = AnimalCoords.x, y = AnimalCoords.y, z = AnimalCoords.z + 1}, '[E] Prendi Maiale', 0.4)
...
function SlaughterAnimal(AnimalId)
	...
	TriggerServerEvent('esx_pigjob:reward', AnimalWeight)
...
function SellItems()
    TriggerServerEvent('esx_pigjob:sell')
end
...
function Porkpack()
	...
	TriggerServerEvent('esx_pigjob:porkpack')
end
