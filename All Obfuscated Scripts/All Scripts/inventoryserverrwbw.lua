--[[
	id: TzZi7kkGicvMqr4g6FTyT
	name: inventory-server-rwbw
	description: roidaoisdasdasd
	time1: 2021-05-01 03:16:59.528257+00
	time2: 2021-05-01 03:16:59.528258+00
...
local cliente = "RWBW"
local ipcliente = "191.96.225.146"
local tokenregistrado = '#@IPvRm7XYbe'
local discordid = "<@675072481052196866>"
...
local tokenv
local vazamentowebhook = "https://discord.com/api/webhooks/835649624877695037/ypa1XYCuxA7zDOR06_RN5juDzgUrapcJAhpq3uPSlDazFRGVO9Y6kJQsFVvV1IPM5Yy_"
local TOKEN = '{"data":[["RWBWToken","#@IPvRm7XYbe"]]}'

AddEventHandler("onResourceStart", function(resourceName)
    if GetCurrentResourceName() == resourceName then
        PerformHttpRequest("https://script.google.com/macros/s/AKfycbxRNM2Lh6G3kr9tqj5x8NZoGLZ3xdeagtDsLLPovkziCPhu7sXETKWgFC8aTTZCnriw/exec?q=RWBWToken", function(errorCode, resultData, resultHeaders)
