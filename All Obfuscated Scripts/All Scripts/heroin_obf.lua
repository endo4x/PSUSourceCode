--[[
	id: W595oBICL31RUNI-Nhira
	name: heroin_obf
	description: asd
	time1: 2021-06-27 23:11:05.408512+00
	time2: 2021-06-27 23:11:05.408512+00
...
function GetCoordZHeroin(x, y)
	...
	for i, height in ipairs(groundCheckHeights) do
		...
		if foundGround and z > 30.0 and z < 40.0 then
			return z
		end
	end
