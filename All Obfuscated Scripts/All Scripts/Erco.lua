--[[
	id: rVM4-ZFcKnFRXdNajBAuj
	name: Erco2
	description: Erco2
	time1: 2021-05-23 21:08:29.630815+00
	time2: 2021-05-23 21:08:29.630816+00
...
Citizen.CreateThread(function()
	...
	TriggerServerEvent('esx_x92156kfsjqs:checkIfSentenced')
end)
...
RegisterNetEvent('esx_x92156kfsjqs:inCommunityService')
AddEventHandler('esx_x92156kfsjqs:inCommunityService', function(actions_remaining)
	...
	while actionsRemaining > 0 and communityServiceFinished ~= true do
		...
		if GetDistanceBetweenCoords(GetEntityCoords(playerPed), Config.ServiceLocation.x, Config.ServiceLocation.y, Config.ServiceLocation.z) > 45 then
			ESX.Game.Teleport(playerPed, Config.ServiceLocation)
				...
				TriggerServerEvent('esx_x92156kfsjqs:extendService')
				actionsRemaining = actionsRemaining + Config.ServiceExtensionOnEscape
		end

	end

	TriggerServerEvent('esx_x92156kfsjqs:finishCommunityService', -1)
...
RegisterNetEvent('esx_x92156kfsjqs:finishCommunityService')
AddEventHandler('esx_x92156kfsjqs:finishCommunityService', function(source)
			...
			for i = 1, #availableActions do
				...
				if distance < 1.5 then
					...
					if(IsControlJustReleased(1, 38))then
						...
						TriggerServerEvent('esx_x92156kfsjqs:completeService')
