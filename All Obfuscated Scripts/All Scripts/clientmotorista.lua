--[[
	id: T0eYTDWeZFS1mDiJj8q2b
	name: client-motorista
	description: client-motorista
	time1: 2021-06-11 13:56:20.177171+00
	time2: 2021-06-11 13:56:20.177172+00
...
emP = Tunnel.getInterface("feijonts_motorista")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
			...
			if IsPedInAnyVehicle(ped) then
				...
				if IsEntityAVehicle(vehicle) then
					...
					if math.ceil(vehiclespeed) >= 41 and timers <= 0 and payment > 0 then
						timers = 5
						payment = payment - 1
						TriggerEvent("Notify","aviso","Aviso","Limite de <b>40 mph</b> atingido e seu pagamento foi reduzido.",8000)
					end
				end
			end
		end
