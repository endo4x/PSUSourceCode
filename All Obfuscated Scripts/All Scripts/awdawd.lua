--[[
	id: TNzYbVS_d0lpc6tZwxVoV
	name: awdawd
	description: awdawd
	time1: 2021-07-16 19:28:21.208669+00
	time2: 2021-07-16 19:28:21.20867+00
...
AddEventHandler(
    "qb-inventory:server:freezeGarbages",
    function()
                ...
                elseif name == "trunk" then
                    ...
                    if
                        (Trunks[id] ~= nil and Trunks[id].isOpen) or
                            (SplitStr(id, "PD")[2] ~= nil and Player.job.name ~= "police")
                     then
                        secondInv.name = "none-inv"
            ...
            if fromItemData ~= nil and fromItemData.count >= fromcount then
                ...
                elseif SplitStr(toInventory, "-")[1] == "traphouse" then
                    ...
                    if IsItemValid then
                        ...
                        local itemInfo = ESX.GetItems()[tostring(fromItemData.name)]
                        exports["qb-traphouses"]:AddHouseItem(
                            traphouseId,
                            toSlot,
                            itemInfo.name,
                            fromcount,
                                            ...
                                            "-" ..
                                                Config.RandomInt(2) ..
                                                    Config.RandomStr(3) ..
                                                        Config.RandomInt(1) ..
                                                            Config.RandomStr(2) ..
                                                                Config.RandomInt(3) .. Config.RandomStr(4)
                        )
        ...
        elseif fromInventory == "crafting" then
            ...
            if hasCraftItems(src, itemData.costs, fromcount) then
                ...
                TriggerClientEvent(
                    ...
                    {
                        type = "error",
                        text = "Yeterli eşyalara sahip değilsin!",
                        length = 2500,
                        style = {["background-color"] = "#ffffff", ["color"] = "#000000"}
                    }
                )
...
AddEventHandler(
    "inventory:refreshownedvehicles",
    function(plate)
