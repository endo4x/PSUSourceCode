--[[
	id: ibkQK75OK6T1raCylg1No
	name: kp_frumento
	description: racolta frumento
	time1: 2021-04-24 14:11:06.885332+00
	time2: 2021-04-24 14:11:06.885333+00
...
Citizen.CreateThread(function()
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('kp_frumento:canPickUp', function(canPickUp)
 ...
 TriggerEvent("mythic_progbar:client:progress", {
						...
						TriggerServerEvent('kp_frumento:pickedUpCannabis')
					else
...
function SpawnBeees()
	while spawnedBees < 20 do
		...
		ESX.Game.SpawnLocalObject('prop_plant_cane_02b', sandCoords, function(obj)
