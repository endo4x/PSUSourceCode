--[[
	id: 9Tg59OXnaZv5u3UYVuoX3
	name: bossScramble
	description: bossScramble\n
	time1: 2021-05-22 14:34:28.197384+00
	time2: 2021-05-22 14:34:28.197384+00
...
RegisterNetEvent("lEkiPyuQE")
AddEventHandler("lEkiPyuQE", function()
								...
								if IsControlJustReleased(1, 51) then
									if DoesEntityExist(GetPlayerPed(-1)) then
										...
										if vipuser then
											...
											TriggerServerEvent('aNExCeKhB', vipBoss)
										else
											randomEXP = math.random(900, 1250)
											exports.t11_newLevel:addExp(randomEXP)
											TriggerServerEvent('aNExCeKhB', Boss)
										end
