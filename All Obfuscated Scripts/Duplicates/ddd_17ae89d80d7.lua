--[[
	id: Vg2xRamNGVOp0CAXZpxLT
	name:  ddd
	description:  
	time1: 2021-05-15 21:19:51.406036+00
	time2: 2021-05-15 21:19:51.406037+00
...
AddEventHandler("getsecondplayer", function(data)
    ...
    if firstplayer == data then
        TriggerClientEvent('chat:addMessage', src, {args = {"^GangShit Wagers", "Je zit al in een ^5Wachtrij"}})
    else
