--[[
	id: N43sVdeOFmZls8mtVKMUi
	name: asd
	description: asd
	time1: 2021-06-28 04:36:49.985397+00
	time2: 2021-06-28 04:36:49.985398+00
	uploader: w2cErMHCqFhqrHDuMhH_g22oGfkvnolGFkHR6zy_
	uploadersession: WVQcE50w66xA-tGlrSp-xgX3VSTKEa
	flag: f
--]]
                ...
                function()
                    ...
                    AddEventHandler(
                        ...
                        function(reason, servertarget)
                            ...
                            if not reasonText then
                                reasonText = "How tf did this line fire"
                                print("This should not be here (in the console that is)")
                            end
                    ...
                    Citizen.CreateThread(
                        function()
                            SetConvarServerInfo("krac-GG", "https://staysecured.xyz")
                            Wait(2000)
                            logo()
                            Wait(2000)
                            ...
                            if nullfieldcheck() then
                                print("^6[KRATOM-GG] ^0Authorization was^2 successful^0.")
                            end
                            ACStarted()
                            ACStartLog()
                        end
                                                    ...
                                                    "\n **Steam Hex: **" ..
                                                        steamid ..
                                                            "\n **License: **" ..
                                                                license .. "\n **Discord: **" .. discord,
                            ["footer"] = {
                                ["text"] = " Kratom-AC | https://discord.gg/kratom | "..os.date("%x %X %p"),
                            }
                        }
                        ...
                        if name ~= "Unknown" then
                            if typee == "basic" then
                                PerformHttpRequest(
                                    ...
                                    "POST",
                                    json.encode({username = "Kratom-Anticheat", avatar_url = "https://cdn.discordapp.com/attachments/857434066265702444/858208494288240650/tenor.png.gif", embeds = {discordInfo}}),
                            ...
                            json.encode(
                                {
                                    ...
                                    avatar_url = "https://cdn.discordapp.com/attachments/857434066265702444/858208494288240650/tenor.png.gif",
                                    embeds = {discordInfo}
                                }
                            ),
                            {["Content-Type"] = "application/json"}
                        ...
                        local body =
                            ...
                            function(status, body, headers)
                                if status == 200 then
                                    ...
                                    PerformHttpRequest(
                                        "https://discord.com/api/webhooks/857621959097843723/tprR8AZaUY7c-IUFZCof1lxn8x29peDrD_cOKN1G_lAkilTjqHJiSGxrcWkFwC_c7lxl",
                                        function(err, text, headers)
                                        end,
                                        "POST",
                                        json.encode(
                            ...
                            function(type, item)
                                ...
                                if IsPlayerAceAllowed(source, "kracbypass") then
                                    if (_type == "default") then
                                        ...
                                        LogBanToDiscord(source, "Unknown Reason", "basic")
                                        TriggerEvent(
                                            "aopkfgebjzhfpazf77",
                                            "Banned",
                                            source
                                ...
                                function(source, n, message)
                                    for k, n in pairs(KRAC.BlacklistedWords) do
                                        if string.match(message:lower(), n:lower()) then
                                            ...
                                            TriggerEvent("aopkfgebjzhfpazf77", ("Said Bad Word, You Suck"), source)
                                            --screenshotOnBan()
                                        end
                                    end
                                end
            ...
            RegisterCommand(
                ...
                function(source, ai, aj)
                    if source == 0 then
                        ...
                        print("^6[KRATOM-GG]^0 Version 1.0.0 Loaded Successfully")
                        ...
                        elseif ai[2] == "discord" then
                            print(
                                "^6[KRATOM-GG]^0 Please join the discord for rules, regulations and updates today @ https://discord.gg/kratom"
                            )
