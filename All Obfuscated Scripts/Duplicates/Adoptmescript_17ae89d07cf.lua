--[[
	id: XvnXytWkIoe-yhtAv_7Lx
	name: Adopt me script
	description: AdoptmeScript with outdated features
	time1: 2021-05-08 18:16:10.882472+00
	time2: 2021-05-08 18:16:10.882472+00
	uploader: 3674
	uploadersession: Z9MbFkDAOGeFbxTptHiLvJWXFnT-GS
	flag: f
--]]
...
local w = Library:Window("Teleportations")

w:Button("City", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.Neighborhood.Doors.MainDoor.WorkingParts.TouchToEnter.CFrame

   print("[ADOPT ME SCRIPT V1.0] Teleported to exitTunnel")
end)

w:Button("Neighborhood", function()
 
  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Neighborhood/MainDoor"].WorkingParts.TouchToEnter.CFrame
  
   print("[ADOPT ME SCRIPT V1.0] Teleported to Neighborhood!")
end)

w:Button("Hospital", function()
 

   game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Hospital/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Hospital!")
end)

--------------------------------------

w:Button("Coffe shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["CoffeeShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Coffe shop!")
end)

--------------------------------------

w:Button("SuperMarket", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Supermarket/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to SuperMarket!")
end)

--------------------------------------

w:Button("Pizza shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["PizzaPlace/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Pizza shop!")
end)

--------------------------------------

w:Button("Toy shop", function()
 
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["ToyShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
  
   print("[ADOPT ME SCRIPT V1.0] Teleported to Toy shop!")
end)

--------------------------------------

w:Button("Obbies", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Obbies/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Obbies!")
end)

--------------------------------------

w:Button("Camping shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["CampingShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Camping shop!")
end)

--------------------------------------

w:Button("Car dealer", function()
 

  
   print("[ADOPT ME SCRIPT V1.0] Teleported to Car dealer!")
end)

--------------------------------------

w:Button("Nursery", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Nursery/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Nursery!")
end)

--------------------------------------

w:Button("PlayGround", function()
 
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["PlayGround/Plot"].WorkingParts.TouchToEnter.CFrame
  
   print("[ADOPT ME SCRIPT V1.0] Teleported to PlayGround!")
end)
--------------------------------------

w:Button("Cave", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Cave/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Cave!")
end)

--------------------------------------

w:Button("Ice cream shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["IceCream/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Ice cream shop!")
end)

--------------------------------------

w:Button("Potion Shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["PotionShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Potion Shop!")
end)

w:Button("Sky castle", function()
 
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["SkyCastle/MainDoor"].WorkingParts.TouchToEnter.CFrame
  
   print("[ADOPT ME SCRIPT V1.0] Teleported to Sky castle!")
end)

w:Button("Hat Shop", function()
 
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["HatShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
  
   print("[ADOPT ME SCRIPT V1.0] Teleported to Hat Shop!")
end)

w:Button("Pet Shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["PetShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Pet Shop!")
end)

w:Button("School", function()
 
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["School/MainDoor"].WorkingParts.TouchToEnter.CFrame

  
   print("[ADOPT ME SCRIPT V1.0] Teleported to School!")
end)

w:Button("Baby shop", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["BabyShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Baby shop!")
end)

w:Button("Hotspring House", function()
 

  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["HotSpringHouse/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Hot spring!")
end)

w:Button("Car dealer", function()
 
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["AutoShop/MainDoor"].WorkingParts.TouchToEnter.CFrame
  
   print("[ADOPT ME SCRIPT V1.0] Teleported to Hot spring!")
end)


w:Button("Safetey hub", function()
 

   game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["SafetyHub/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to Safetey hub!")
end)

w:Button("Feed Dragon Minigame", function()
 

   game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["FeedDragonMinigame/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to feed dragon minigame hub!")
end)

w:Button("IceCastle", function()
 

   game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["IceCastle/MainDoor"].WorkingParts.TouchToEnter.CFrame
   print("[ADOPT ME SCRIPT V1.0] Teleported to IceCastle!")
end)

local w = Library:Window("AUTOFARM")

w:Button("Start gingerbread autofarm", function()
   getgenv().viki = true
while getgenv().viki == true do
    wait(.1)
    for i, v in pairs (game.Workspace.Interiors.MainMap:GetDescendants()) do
        if v.Name == "GingerbreadMan" then
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
           wait(.5)
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").StaticMap.Winter2020.IceSkating.GingerbreadCollectionNavPart.CFrame
        end
    end
end
end)

w:Button("Stop gingerbread autofarm", function()
...
w:Button("Auto Paycheque", function()
     print("Autu Paycheque is currenlty patched please wait for an")
end)

w:Button("Pet Grow", function()
    print("Pet Grow is currenlty patched please wait for an update")
    end)


local w = Library:Window("Extras viki#0001")

w:Toggle("AntiAfk", function(v)
    
        game.StarterGui:SetCore("SendNotification", {
    Title = "Adopt me script v1.0";
...
game:GetService("Players").LocalPlayer.Idled:connect(function()
   ...
   vu:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
    ...
    w:Button("ShatterVast (admin)", function()
-- By illremember#3799
...
w:Button("Exit area", function()
    if game.Workspace.Interiors:FindFirstChild("Neighborhood") then
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.Neighborhood.Doors.MainDoor.WorkingParts.TouchToEnter.CFrame
    else
        if game.Workspace.Interiors:FindFirstChild("MainMap") then
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors.MainMap.Doors["Neighborhood/MainDoor"].WorkingParts.TouchToEnter.CFrame
        else
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Interiors:FindFirstChildWhichIsA("Model").Doors.MainDoor.WorkingParts.TouchToEnter.CFrame
        end
    end
end)
