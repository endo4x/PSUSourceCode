--[[
	id: knf7y1PbZPnIrVO9ryhpa
	name: Test
	description: Test
	time1: 2021-06-02 23:35:39.103812+00
	time2: 2021-06-02 23:35:39.103813+00
    ...
    function()
        while true do
            ...
            for key, value in pairs(laden) do
                DrawMarker(
                    20,
                    vector3(value.x, value.y, value.z + 1),
                    0.0,
                    0.0,
                    0.0,
                    0,
